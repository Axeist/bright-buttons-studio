...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-full p-1.5 text-foreground/50 opacity-0 transition-all group-hover:opacity-100 group-hover:bg-primary/10 group-hover:text-primary group-[.destructive]:text-red-300 hover:text-foreground group-[.destructive]:hover:text-red-50 group-[.destructive]:hover:bg-destructive/20 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-primary/50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className,
    )}
    toast-close=""
    {...props}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn("text-base font-semibold text-foreground", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn("text-sm text-muted-foreground opacity-90", className)} {...props} />
));
