-- FINAL Customer Authentication System Fix
-- This migration provides a comprehensive fix for the customer authentication system
-- It addresses the "function gen_salt(unknown) does not exist" error by using proper type casting
-- and ensures all required functions and permissions are in place
...
-- ============================================================================
-- STEP 2: Fix create_customer_auth function
-- This is the CRITICAL function that was causing the signup error
-- ============================================================================
...
DECLARE
  ...
  _salt_type TEXT := 'bf';
BEGIN
  -- Generate password hash using pgcrypto with explicit type casting
  -- Using a variable for the salt type ensures proper type resolution
...
-- ============================================================================
-- STEP 4: Fix update_customer_password function
-- ============================================================================
...
BEGIN
  ...
  _new_password_hash := crypt(_new_password, gen_salt(_salt_type));
...
-- ============================================================================
-- STEP 5: Fix reset_customer_password function
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE 'All functions have been created/updated with proper type handling';
  RAISE NOTICE 'The gen_salt error should now be resolved';
